...
(function (root, factory) {
  ...
  var SPECIAL_REGIONS = [
    { name: "15q11.2-q13 (PWS/AS kritik bölge)", kind: "imprint",
      GRCh37: { chr: "15", start: 23600000, end: 28400000 },
      GRCh38: { chr: "15", start: 23300000, end: 28100000 },
      note: "İmprinted bölge. Köken ebeveyn belirleyicidir; delesyonun anneden mi babadan mı geldiği fenotipi değiştirir. Metilasyon analizi ve ebeveyn çalışması gerekir." },
    { name: "11p15.5 (BWS / Silver-Russell)", kind: "imprint",
      ...
      note: "İmprinted bölge (IC1/IC2). Metilasyon analizi olmadan yorumlanmamalıdır." },
    { name: "14q32.2 (Temple / Kagami-Ogata)", kind: "imprint",
      GRCh37: { chr: "14", start: 100800000, end: 101100000 },
      GRCh38: { chr: "14", start: 100330000, end: 100630000 },
      note: "İmprinted DLK1/MEG3 bölgesi. Köken ebeveyn tayini gerekir." },
    { name: "6q24 (geçici neonatal diabetes)", kind: "imprint",
      GRCh37: { chr: "6", start: 144000000, end: 144400000 },
      GRCh38: { chr: "6", start: 143680000, end: 144080000 },
      note: "İmprinted PLAGL1/HYMAI bölgesi." },
    { name: "20q13.32 (GNAS)", kind: "imprint",
      GRCh37: { chr: "20", start: 57400000, end: 57520000 },
      GRCh38: { chr: "20", start: 58810000, end: 58930000 },
      note: "İmprinted GNAS lokusu; psödohipoparatiroidizm ayrımı köken ebeveyne bağlıdır." },

    { name: "1q21.1 distal (del/dup)", kind: "penetrance",
      GRCh37: { chr: "1", start: 146500000, end: 147900000 },
      GRCh38: { chr: "1", start: 146000000, end: 147400000 },
      note: "Azalmış penetrans / değişken ekspresyon. Etkilenmemiş ebeveynden kalıtılmış olması benign yapmaz." },
    { name: "15q11.2 BP1-BP2 (NIPA1)", kind: "penetrance",
      GRCh37: { chr: "15", start: 22800000, end: 23100000 },
      GRCh38: { chr: "15", start: 22550000, end: 22850000 },
      note: "Düşük penetranslı yatkınlık lokusu. ClinGen bu bölgeyi tek başına tanısal saymaz." },
    { name: "15q13.3 BP4-BP5 (CHRNA7)", kind: "penetrance",
      ...
      note: "Azalmış penetrans; sıklıkla etkilenmemiş ebeveynden kalıtılır." },
    { name: "16p11.2 proksimal (~593 kb)", kind: "penetrance",
      GRCh37: { chr: "16", start: 29600000, end: 30200000 },
      GRCh38: { chr: "16", start: 29590000, end: 30190000 },
      note: "Değişken ekspresyon; OSB/gelişme geriliği yatkınlığı. Kalıtılmış olması dışlayıcı değildir." },
    { name: "16p11.2 distal (~220 kb, SH2B1)", kind: "penetrance",
      ...
      note: "Obezite ve gelişimsel yatkınlık; azalmış penetrans." },
    { name: "16p12.1", kind: "penetrance",
      GRCh37: { chr: "16", start: 21900000, end: 22450000 },
      GRCh38: { chr: "16", start: 21890000, end: 22440000 },
      note: "İkinci vuruş (two-hit) modeli; tek başına tanısal değildir." },
    { name: "16p13.11", kind: "penetrance",
      GRCh37: { chr: "16", start: 15400000, end: 16300000 },
      GRCh38: { chr: "16", start: 15300000, end: 16200000 },
      note: "Düşük penetranslı yatkınlık lokusu." },
    { name: "17q12 (HNF1B)", kind: "penetrance",
      GRCh37: { chr: "17", start: 34800000, end: 36300000 },
      GRCh38: { chr: "17", start: 36450000, end: 37950000 },
      note: "Renal kistik hastalık / MODY5; değişken ekspresyon, kalıtılmış olabilir." },
    { name: "22q11.2 distal (LCR D-E/F)", kind: "penetrance",
      GRCh37: { chr: "22", start: 21000000, end: 21900000 },
      GRCh38: { chr: "22", start: 20600000, end: 21500000 },
      note: "Distal delesyon; klasik 22q11.2DS'den farklı, değişken fenotip." },
    { name: "2q13", kind: "penetrance",
      GRCh37: { chr: "2", start: 111300000, end: 112000000 },
      GRCh38: { chr: "2", start: 110540000, end: 111240000 },
      note: "Düşük penetranslı yatkınlık lokusu." }
  ];
